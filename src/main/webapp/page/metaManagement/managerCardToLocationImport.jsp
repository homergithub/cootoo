...
function downloadFile(){
	$("#iframe").attr("src","<%=basePath%>metaManagement/downloadModel.do?fileName=managerCardToLocation.xlsx");
}
...
<body>
<h5>管理门卡－管理范围信息导入</h5>
<form id="dataImport" action="<%=basePath%>metaManagement/addManagerCardToLocation.do" method="post" enctype="multipart/form-data">
