...
function downloadFile(){
	$("#iframe").attr("src","<%=basePath%>metaManagement/downloadModel.do?fileName=peopleToCard.xlsx");
}
...
<body>
<h5>住户-门卡信息导入</h5>
<form id="dataImport" action="<%=basePath%>metaManagement/userCardImport.do" method="post" enctype="multipart/form-data">
