...
function downloadFile(){
	$("#iframe").attr("src","<%=basePath%>metaManagement/downloadModel.do?fileName=department.xlsx");
}
...
<body>
<h5>部门信息导入</h5>
<form id="dataImport" action="<%=basePath%>metaManagement/departImport.do" method="post" enctype="multipart/form-data">
