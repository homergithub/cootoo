...
function downloadFile(){
	$("#iframe").attr("src","<%=basePath%>metaManagement/downloadModel.do?fileName=unitLocation.xlsx");
}
...
<body>
<h5>建筑单元信息导入</h5>
<form id="dataImport" action="<%=basePath%>metaManagement/unitLocationImport.do" method="post" enctype="multipart/form-data">
