...
function downloadFile(){
	$("#iframe").attr("src","<%=basePath%>metaManagement/downloadModel.do?fileName=peopleToLocation.xlsx");
}
...
<body>
<h5>住户－房间信息导入</h5>
<form id="dataImport" action="<%=basePath%>dormManagement/peopleToLocationImport.do" method="post" enctype="multipart/form-data">
